  ...
  return (
    <Stack direction={'row'} justifyContent={'space-evenly'} sx={{backgroundColor:'white' ,width:'100%' , height:'102vh'}}>
             ...
             <motion.div
                ...
                >
                    <Box id='pillars-wraper'  m={2} sx={{width:'300px' , height:'400px' , display:'flex' , flexDirection:'column' ,borderRadius:'15px 15px'  , justifyContent:'center' , gap:'15px',  backgroundImage:
